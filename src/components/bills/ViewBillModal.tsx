      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-[#2d6e7e] text-white rounded-t-lg">
          <div className="flex items-center gap-2">
            <FileText size={20} />
            <h2 className="text-xl font-bold">รายละเอียดบิล {bill.invoiceID}</h2>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium">{bill.checktime ? formatDate(bill.checktime) : "ยังไม่ชำระ"}</p>
              </div>
              <div>
                <p className="text-gray-500">เวลาชำระ:</p>
                <p className="font-medium">{bill.checktime ? formatTime(bill.checktime) : "ยังไม่ชำระ"}</p>
              </div>
              <div>
                <p className="text-gray-500">วิธีการชำระ:</p>
                <p className="font-medium">เงินสด</p> {/* Adjust this if you have different payment methods */}
              </div>
              <div>
                <p className="text-gray-500">ผู้รับชำระ:</p>
                <p className="font-medium">มิตรา</p> {/* Adjust this if you have different cashiers */}
              </div>
            </div>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="py-2 px-4 text-center">ภาพ</th>
                </tr>
              </thead>
              <tbody>
...
//   // Mock bill items
//   const billItems: BillItem[] = [//change to be from backend
//     {
//       id: 1,
//       name: "ทองแดง#1",
//       weight: 5.2,
